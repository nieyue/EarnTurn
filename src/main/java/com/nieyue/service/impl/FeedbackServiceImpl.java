...
public class FeedbackServiceImpl implements FeedbackService{
	...
	public int countAll(Integer acountId) {
		int c = feedbackDao.countAll(acountId);
		return c;
	}

	@Override
	public List<Feedback> browsePagingFeedback(Integer acountId,int pageNum, int pageSize,
		...
		List<Feedback> l = feedbackDao.browsePagingFeedback(acountId,pageNum-1, pageSize, orderName, orderWay);
		return l;
	}
